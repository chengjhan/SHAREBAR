...
@WebServlet("/administrator/MailSelectForCustomerServlet")
public class MailSelectForCustomerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (!errors.isEmpty()) {
			RequestDispatcher rd = request.getRequestDispatcher("gm_view05_1.jsp");
