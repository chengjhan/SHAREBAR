...
public class ItemService {
	...
	public static void main(String[] args) throws ParseException {
		...
		// selectByLatLng
		for (ItemBean bean : itemService.selectByLatLng(25.033, 121.543, 25.041, 121.564)) {
			System.out.println(bean);
		}

		// selectByBoundsByName
		for (ItemBean bean : itemService.selectByBoundsByName(25.031836, 121.555604, 25.034534, 121.558302, "衣寫")) {
			System.out.println(bean);
		}
